...
btn.addEventListener("click", function () {
  ...
  // Define the API URL
  let apiUrl = "https://api.nationalize.io?name=" + nameTxt;
  ...
  fetch(apiUrl)
    ...
    .then((data) => {
      console.log(data);
      let countries = data.country; // Access the 'country' property
      let countryNames = [];
...
console.log("Debug: app started");
      ...
      for (let country of countries) {
        ...
        if (countryMap.hasOwnProperty(countryId)) {
          countryNames.push(countryMap[countryId]);
        }
      }

      // Display the concatenated country names
      if (countryNames.length > 0) {
        para.innerText = "You may live in " + countryNames.join(", ");
      } else {
        para.innerText = "Unknown country";
      }
    })
    .catch((err) => {
      console.log(err);
